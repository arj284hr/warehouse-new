  ...
  <!--   <script>
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-8 col-lg-8">
            <form action="{{route('admin.carrier-invoice')}}" method = "POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-row">
        ...
        <div class="form-group col-6 col-md-6 col-lg-6 m-auto">
            ...
            <input type="submit" name = "submit" id="submit" class = "btn btn-sm btn-primary form-control" value = "Get Carrier Invoice">
        </div>
    </div>
</form>
</div>
...
<div class="container">
   ...
   <div class="row">
    ...
    <div class="mb-2 text-right w-100">
        ...
        <a href="{{ route('admin.export-carrier-excel') }}"><button type="button" class="btn btn-warning  " data-toggle="modal" data-target="#add_anauncement">
            <i class="fa fa-download"></i> Download
          </button></a>

      </div>
                  <div class="col-md-12 text-right" style="height: 300px; overflow-y: auto" id='print'>
