  ...
  <!--   <script>
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-8 col-lg-8">
            <form action="{{route('admin.fix-report')}}" method = "POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-row">
        ...
        <div class="form-group col-6 col-md-6 col-lg-6 m-auto">
            ...
            <input type="submit" name = "submit" id="submit" class = "btn btn-sm btn-primary form-control" value = "Get Fix Payroll">
        </div>
    </div>
</form>
</div>
...
<div class="container">
   ...
   <div class="row">
    ...
    <div class="mb-2 text-right w-100">
        ...
        <a href="{{ route('admin.export-fix-only-Pay') }}"><button type="button" class="btn btn-warning  " data-toggle="modal" data-target="#add_anauncement">
                        ...
                        <tbody>
                            @foreach($reports as $report)
                                <tr>
                                   ...
                                   <td>@if( !empty($report->load_details->employee_total_pay) )
