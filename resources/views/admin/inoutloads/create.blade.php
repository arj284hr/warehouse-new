...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-md-2">
      <a href="{{ route('admin.inoutloads.index') }}" class = "btn btn-primary">View All <i class = "fa fa-eye"></i></a>
    </div>
  </div>
  <br>
  <div class="row">
    ...
    <div class="col-md-12">
      <form action="{{ route('admin.inoutloads.store') }}" method = "POST" enctype="multipart/form-data">
        {{ csrf_field() }}
