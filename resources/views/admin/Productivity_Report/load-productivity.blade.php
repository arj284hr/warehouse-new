    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-center">
                <h4>Load Productivity Report</h4>
  ...
  <!--   <script>
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-8 col-lg-8">
            <form action="{{route('admin.load-productivity')}}" method = "POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-row">
        ...
        <div class="form-group col-6 col-md-6 col-lg-6 m-auto">
            ...
            <input type="submit" name = "submit" id="submit" class = "btn btn-sm btn-primary form-control" value = "Get Load Productivity">
        </div>
    </div>
</form>
</div>
...
<div class="container">
   ...
   <div class="row">
    @if($productivity->count() > 0)
    <div class="mb-2 text-right w-100">
        

        <a href="{{ route('admin.export-Load-Productivity') }}"><button type="button" class="btn btn-warning  " data-toggle="modal" data-target="#add_anauncement">
                    ...
                    <table class="table table-bordered data-table">
                        <thead>
                           ...
                           {{--  <th>Date range</th> --}}
                            ...
                            <th>Pieces</th> 
                            <th>Total Charge</th>
                            <th>Total load/project Loads per hr</th>
                            <th>Cases per hr</th>
                            <th>Pieces per hr</th>
                        ...
                        <tbody>
                            @foreach($productivity as $invoice)
                                <tr>
                                 ...
                                 {{--   <td>@if( $invoice-> )
                                   ...
                                   <td>
                                    @if( $invoice->special_charges )
                                    {{ $invoice->special_charges}}
                                    @else
                                    N/A
                                    @endif
                                   </td>
