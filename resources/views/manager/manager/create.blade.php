    ...
    <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" name="job_title" value="manager" disabled placeholder="Manager" required>
          </div>
          <div class="form-group col-md-4">
              <label for="">Hiring Date</label>
              <input type="text" class="form-control" name="hiring_date" placeholder="YYYY-MM-DD" required>
          </div>
          <div class="form-group col-md-4">
