...
@section('content')
    <div class="container-fluid">
        <div class="row">
          ...
          {{--   <div class="col-md-1">
                <a href="{{ route('manager.employee.create') }}" class = "btn btn-sm btn-primary" >Add New <i class = "fa fa-plus"></i></a>
            </div> --}}
        </div>
        <div class="row">
                        ...
                        <tbody>
                            @foreach($employees as $employee)
                                <tr>
                                   ...
                                   {{--  <td>
                                        <a href="{{ route('manager.employee.show', $employee->id) }}" class = "btn btn-sm btn-info"><i class = "fa fa-eye"></i></a>
                                    </td> --}}
                                   {{--  <td>
